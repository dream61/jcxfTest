...
def testscenario_list(request):
    ...
    # 分页设置，使用处理后的每页显示条数
    paginator = Paginator(testscenarios, per_page)
    ...
    return render(request, 'testscenarios/testscenario_list.html', {'testscenarios': testscenarios_page, 'testcases': testcases,'paginator': paginator,'per_page': per_page,
